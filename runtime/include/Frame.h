...
public:
	...
	ObjectInstance* CreateInstance(ObjectInstance* createdInstance, short x, short y, unsigned int layer, unsigned int objectInfoHandle, short angle, ObjectInstance* parentInstance = nullptr);
